...
REM and starts the FastAPI server with uvicorn on port 3000.
...
echo Starting FastAPI server via uvicorn on port 3000
.venv_run\Scripts\python.exe -m uvicorn app.main:app --reload --port 3000
